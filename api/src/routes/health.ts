    ...
    return reply.status(healthy ? 200 : 503).send({
      ...
      backups: backupOverview
        ? {
            ...
            database_size_bytes: backupOverview.summary.database_size_bytes,
            stored_backup_size_bytes: backupOverview.summary.stored_backup_size_bytes,
            stored_backup_size_by_trigger: backupOverview.summary.stored_backup_size_by_trigger,

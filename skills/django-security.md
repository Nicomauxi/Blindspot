...
description: "Django security: authentication, authorization, CSRF, SQL injection prevention, XSS prevention, and secure deployment."
activation:
  - "The user explicitly asks to use django-security."
  - "Assessing authentication, authorization, input handling, secrets, or supply-chain risk."
  - "Task context matches: Django security: authentication, authorization, CSRF, SQL injection prevention, XSS prevention, and secure deployment."
---

...
description: "Docker and Docker Compose patterns for local development, container security, networking, volumes, and multi-service orchestration."
activation:
  - "The user explicitly asks to use docker-patterns."
  - "Assessing authentication, authorization, input handling, secrets, or supply-chain risk."
  - "Task context matches: Docker and Docker Compose patterns for local development, container security, networking, volumes, and multi-service orchestration."
---

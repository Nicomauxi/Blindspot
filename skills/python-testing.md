---
name: python-testing
description: "Python testing with pytest, TDD methodology, fixtures, mocking, parametrization, and coverage requirements."
activation:
  - "The user explicitly asks to use python-testing."
  - "Writing, fixing, or reviewing tests, coverage, or test strategy."
  - "Building or reviewing user-facing interface behavior."
  - "Task context matches: Python testing with pytest, TDD methodology, fixtures, mocking, parametrization, and coverage requirements."
---

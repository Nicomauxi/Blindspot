...
activation:
  - "The user explicitly asks to use iterative-retrieval."
  - "Designing agent workflows, tools, loops, evals, or context retrieval."
  - "Task context matches: Pattern for progressively refining context retrieval to solve the subagent context problem."
---
...
## Patterns
- Apply iterative-retrieval to a matching implementation, review, or planning task.

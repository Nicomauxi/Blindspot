...
description: "React, Next.js, state management, performance optimization, and UI best practices."
activation:
  - "The user explicitly asks to use frontend-patterns."
  - "Building or reviewing user-facing interface behavior."
  - "Changing schemas, queries, persistence, or data access patterns."
  - "Task context matches: React, Next.js, state management, performance optimization, and UI best practices."
---
...
## Patterns
- Apply frontend-patterns to a matching implementation, review, or planning task.

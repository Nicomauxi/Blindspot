---
name: golang-testing
description: "Go testing: table-driven tests, subtests, benchmarks, fuzzing, and test coverage. TDD methodology with idiomatic Go."
activation:
  - "The user explicitly asks to use golang-testing."
  - "Writing, fixing, or reviewing tests, coverage, or test strategy."
  - "Task context matches: Go testing: table-driven tests, subtests, benchmarks, fuzzing, and test coverage. TDD methodology with idiomatic Go."
---

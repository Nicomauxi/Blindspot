---
name: springboot-tdd
description: "TDD for Spring Boot with JUnit 5, Mockito, MockMvc, Testcontainers, and JaCoCo."
activation:
  - "The user explicitly asks to use springboot-tdd."
  - "Writing, fixing, or reviewing tests, coverage, or test strategy."
  - "Task context matches: TDD for Spring Boot with JUnit 5, Mockito, MockMvc, Testcontainers, and JaCoCo."
---

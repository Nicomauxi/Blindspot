---
name: perl-security
description: "Comprehensive Perl security: taint mode, input validation, safe process execution, DBI parameterized queries, web security, and perlcritic policies."
activation:
  - "The user explicitly asks to use perl-security."
  - "Assessing authentication, authorization, input handling, secrets, or supply-chain risk."
  - "Task context matches: Comprehensive Perl security: taint mode, input validation, safe process execution, DBI parameterized queries, web security, and perlcritic policies."
---

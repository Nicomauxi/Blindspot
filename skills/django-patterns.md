...
description: "Django architecture patterns, REST API design with DRF, ORM best practices, caching, signals, and middleware."
activation:
  - "The user explicitly asks to use django-patterns."
  - "Designing, integrating, or reviewing API contracts."
  - "Changing schemas, queries, persistence, or data access patterns."
  - "Task context matches: Django architecture patterns, REST API design with DRF, ORM best practices, caching, signals, and middleware."
---

...
description: "Write articles, guides, blog posts, tutorials, newsletter issues, and long-form content in a consistent voice."
activation:
  - "The user explicitly asks to use article-writing."
  - "Building or reviewing user-facing interface behavior."
  - "Changing schemas, queries, persistence, or data access patterns."
  - "Task context matches: Write articles, guides, blog posts, tutorials, newsletter issues, and long-form content in a consistent voice."
---
...
## Patterns
- Apply article-writing to a matching implementation, review, or planning task.

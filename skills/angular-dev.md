---
name: angular-dev
description: "Angular development assistant for modifying, optimizing, and building components, services, and modules following project conventions."
activation:
  - "The user explicitly asks to use angular-dev."
  - "Building or reviewing user-facing interface behavior."
  - "Task context matches: Angular development assistant for modifying, optimizing, and building components, services, and modules following project conventions."
---
...
## Patterns
- Apply angular-dev to a matching implementation, review, or planning task.

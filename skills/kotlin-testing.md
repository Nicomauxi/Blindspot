---
name: kotlin-testing
description: "Kotlin testing with Kotest, MockK, coroutine testing, property-based testing, and Kover coverage."
activation:
  - "The user explicitly asks to use kotlin-testing."
  - "Writing, fixing, or reviewing tests, coverage, or test strategy."
  - "Task context matches: Kotlin testing with Kotest, MockK, coroutine testing, property-based testing, and Kover coverage."
---

...
activation:
  - "The user explicitly asks to use jpa-patterns."
  - "Task context matches: JPA/Hibernate patterns for entity design, relationships, query optimization, transactions, auditing, indexing, pagination, and pooling in Spring Boot."
---
...
## Patterns
- Apply jpa-patterns to a matching implementation, review, or planning task.

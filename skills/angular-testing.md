...
description: "Write unit and integration tests for Angular v20+ using Vitest or Jasmine with TestBed and modern testing patterns."
activation:
  - "The user explicitly asks to use angular-testing."
  - "Writing, fixing, or reviewing tests, coverage, or test strategy."
  - "Building or reviewing user-facing interface behavior."
  - "Task context matches: Write unit and integration tests for Angular v20+ using Vitest or Jasmine with TestBed and modern testing patterns."
---

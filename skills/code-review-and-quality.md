...
description: "Multi-axis code review across correctness, security, performance, and maintainability. Use before merging any change."
activation:
  - "The user explicitly asks to use code-review-and-quality."
  ...
  - "Task context matches: Multi-axis code review across correctness, security, performance, and maintainability. Use before merging any change."
---

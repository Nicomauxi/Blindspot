...
description: "Verification loop for Laravel: env checks, linting, static analysis, tests with coverage, security scans, and deployment readiness."
activation:
  - "The user explicitly asks to use laravel-verification."
  ...
  - "Task context matches: Verification loop for Laravel: env checks, linting, static analysis, tests with coverage, security scans, and deployment readiness."
---
